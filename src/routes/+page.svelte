...
{#snippet discordDialogContent()}
	<div>
		...
		<p class="text-blue-400 underline underline-offset-1">
...
<dialog
	...
	class="backdrop:bg-surface-100 dialog-anim inset-0 m-auto bg-transparent backdrop:opacity-40 backdrop:backdrop-blur-sm"
>
	<div class="bg-surface-200 text-text min-w-[280px] rounded-[28px] border-none p-[24px]">
		{@render discordDialogContent()}
...
<div class="flex flex-col gap-8">
	...
	<div>
		...
		<div class="flex flex-row flex-wrap items-center gap-2">
			...
			<Button
				class="group text-xl"
				popover_id="irc"
				popover_title="my ivanirc nick&colon;"
				copy="int4_t"
				onClick={() => (copied = true)}
			>
			...
			<Button
				class="group text-xl"
				popover_id="oftc"
				popover_title="my oftc nick&colon;"
				copy="int4_t"
				onClick={() => (copied = true)}
			>
				<OFTCIcon />
			...
			<Button
				class="group text-xl"
				popover_id="hackint"
				popover_title="my hackint nick&colon;"
				copy="int4_t"
				onClick={() => (copied = true)}
			>
			...
			<Button
				class="group text-xl"
				popover_id="libera"
				popover_title="my libera nick&colon;"
				copy="int4_t"
				onClick={() => (copied = true)}
			>
				<LiberaColorIcon />
			...
			<Button
				class="group text-xl opacity-75"
				popover_id="discord_popover"
				popover_title="my username&colon;"
				popover_header={discordDialogContent}
				popover_content="int4_t"
				onClick={() => discordDialog?.showModal()}
			>
				<DiscordIcon />
				{@render txt('discord')}
			</Button>
	...
	<div>
		...
		<div class="flex flex-row flex-wrap items-center gap-[2px] sm:w-[600px] md:w-[720px]">
			...
			<a href="https://mistablizzard.nekoweb.org">
				<img
					width="88"
					height="31"
					alt="mistablizzard"
