...
<svg width={size} height={size} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 520" style="enable-background:new 0 0 520 520;" xml:space="preserve" class="dark:fill-white fill-black">
